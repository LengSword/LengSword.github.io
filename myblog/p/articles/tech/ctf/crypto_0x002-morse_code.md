# crypto_0x002-morse_code

```python
#!/usr/bin/env/ python3
# -*- coding: utf-8 -*-
##
# @file crypto_0x002_morse_code.py
# @description Morse Code - Crypto
##
# @author LengSword
# @blog lyu63.top
...
class Morse_Code(object):
    def __init__(self, ciphertext, separator="/"):
...
if __name__ == '__main__':
    ...
    text = 'abd12'
    tmp = Morse_Code(text).encrypt()
    print('Text => ' + text)
    print('Code => ' + tmp)
    print('======')
    text = '..-. .-.. .- --. . --... .---- -.-. .- ..... -.-. -.. -....- --... -.. -... ----. -....- ....- -... .- ...-- -....- ----. ...-- ---.. ...-- -....- .---- .- ..-. ---.. -.... --... ---.. ---.. .---- ..-. ----- --...'
    tmp = Morse_Code(text, " ").decrypt().lower()
    print('Code => ' + text)
    print('Text => ' + tmp)
